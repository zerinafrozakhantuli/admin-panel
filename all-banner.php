    ...
    <table class="table table-bordered table-striped table-hover custom_table">
      ...
      <tbody>
        <?php
         ...
         $sel='SELECT * FROM banner NATURAL JOIN roles ORDER BY ban_id ASC';
         $Q=mysqli_query($con,$sel);
         while($data=mysqli_fetch_assoc($Q)){
        ?>
        <tr>
         
          <td><?php $data['ban_title']?></td>
          <td><?php $data['ban_subtitle']?></td>
          <td><?php $data['ban_url']?></td>
          <td><?php $data['ban_button']?></td>
